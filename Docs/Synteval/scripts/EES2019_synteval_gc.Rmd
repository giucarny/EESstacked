...
Full OLS models converge and coefficients do not show any particular issue (see Table \ref{table:full_ols_cy}). 
In terms of model fit, the 
coefficient of determination ($R^2$) values vary between 
...
ols_aic %>% 
  kable(caption = "Akaike Information Criterion values for OLS full and null models \\label{table:ols_aic_cy}", booktabs = T, 
        align = c('l', 'c', rep('r',3))) %>% 
  kable_styling(latex_options = c('striped', 'hold_position'))
...
stargazer::stargazer(fullmod_lst$OLS, 
...
stargazer::stargazer(fullmod_lst$logit, 
