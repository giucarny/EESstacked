...
Synthetic variable have been estimated for the full set of Cypriot parties available in the original 
2019 EES Cypriot voter study (see Table \ref{table:tab_4_8}) <!-- table made with relprty_df-->. 
Full OLS models converge and coefficients do not show any particular issue. On the contrary, two out of 
six full logit models do present unusually high standard errors for some of the coefficients of 
interest. The solutions found for dealing with the latter models are presented below. 
