...
# Model 3 constant term is not affected by D7_rec inflated SE, whereas Model 6 constant is 
# affected showing unusual values. We deal only with model 6 affected by separation issue.
...
# with high subjective social status, and members of trade unions did vote for party 
# 505 (voted by only 5 respondents of the Cypriot sample).
