...
The new variables are then grouped as it follows: 

*  Identification variables: Additional variables in order to identify the the dataset observations. 
This set include simple alternative version of former variables (e.g. countrycode, and countryshort).
