...
of Newcastle.  
More specifically, this data set is the product of the efforts of the ProConEU working package based at 
the MZES of the University of Mannheim. The preparation of the 2019 EES SDM set was led by Hermann 
Schmitt and coordinated by Giuseppe Carteny. Wilhelmine Häußling, Julian Leiser, and Matthias Körnig 
actively participated to the realisation of both data and documentation. The data pipeline and workflow 
were realised between July 2021 and January 2022 making use of R [@r_cit], and are deposited in a public 
online repository available at 
[https://github.com/giucarny/EESstacked](https://github.com/giucarny/EESstacked).
