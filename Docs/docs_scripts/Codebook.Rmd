...
Political parties are considered "*relevant*" on the bases of two criteria. First, a party is considered 
relevant if a 2019 EES voter study includes a propensity to vote (PTV) measure for it. Second, a party 
is labelled as relevant if it obtained at least one seat in the 2019 EP elections. 
