...
relprty_df %>% 
  ...
  kable(caption = "Belgian relevant parties in the Dutch electoral college \\label{table:relprty_tab_be_du}", booktabs = T, 
        align = c('l', 'c', 'l')) %>% 
  kable_styling(latex_options = c('striped', 'hold_position'))
...
relprty_df %>% 
  ...
  select(depvar, partycode, partyname_eng, -elcoll) %>%
  rename('Dep. Var.' = depvar, 'Party' = partycode, 'Party name (eng)' = partyname_eng) %>%
  kable(caption = "Belgian relevant parties in the French electoral college \\label{table:relprty_tab_be_fr}", booktabs = T, 
        align = c('l', 'c', 'l')) %>% 
  kable_styling(latex_options = c('striped', 'hold_position'))
...
stargazer::stargazer(finalmod_lst[['DU-el']]$OLS,
                     title = 'Vote choice for a relevant party according to respondents 
                       socio-demographic characteristics (Dutch Electoral College, Ordinary square models)',
...
logit_regtab <-
  stargazer::stargazer(finalmod_lst[['DU-el']]$logit,
                     title = 'Vote choice for a relevant party according to respondents 
                       socio-demographic characteristics (Dutch Electoral College, Logistic regression models)',
...
ols_regtab <-
  stargazer::stargazer(finalmod_lst[['FR-el']]$OLS,
                       title = 'Vote choice for a relevant party according to respondents
                         socio-demographic characteristics (French Electoral College, OLS regression models)',
...
logit_regtab2 <-
  stargazer::stargazer(finalmod_lst[['FR-el']]$logit,
                     title = 'Vote choice for a relevant party according to respondents 
                       socio-demographic characteristics (French Electoral College, Logistic regression models)',
