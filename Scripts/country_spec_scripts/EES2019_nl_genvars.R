# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Title: Script for Estimating Generic Variables (EES 2019 Voter Study, Netherlands Sample) 
# Author: W. Haeussling
...
#fit_lst <-
#  gensyn.fun(data = EES2019_nl_stack,
#             depvar = 'Q7_gen',
...
#   beginning and end of the qqnorm plots in regard to the qqline.

# If results are fine # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 

EES2019_nl_stack %<>%
  left_join(.,
            lapply(data = EES2019_nl_stack,
