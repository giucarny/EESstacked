...
#fit_lst <-
#  gensyn.fun(data = EES2019_uk_stack,
#             depvar = 'Q7_gen',
...
#   of the qqnorm plots.
#    Furthermore: For the first list entry the coefficient estimate and std. 
#   error values for D6_une1 were unusually high.
#   For the fourth list entry the coefficient estimate and std. error values 
#   for EDU_rec2 and EDU_rec3 were also unusually high.
