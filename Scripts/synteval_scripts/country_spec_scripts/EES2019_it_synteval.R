# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Title: Script for Evaluating Synthetic Variables Estimation (EES 2019 Voter Study, Italian Sample) 
# Author: G.Carteny
...
# No issues detected in any model. Just updated genvars script w/ new vars. 
...
csdf_lst <- list('std'  = EES2019_it,
                 'cdbk' = EES2019_cdbk_it,
                 'SDM'  = EES2019_it_stack)
