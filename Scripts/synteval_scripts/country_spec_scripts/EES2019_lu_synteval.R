# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Title: Script for Evaluating Synthetic Variables Estimation (EES 2019 Voter Study, Luxembourgian Sample) 
# Author: w.Haeussling
...
csdf_lst <- list('std'  = EES2019_lu,
                 'cdbk' = EES2019_cdbk_lu,
                 'SDM'  = EES2019_lu_stack)
...
# logit models 1,2,3 and 5 shows inflated SE on one predictor, more specifically: 
# Models 1,2,3 and 5: D6_une

# Models 1,2,3 and 5 constant terms are not affected by D6_une inflated SE. 
