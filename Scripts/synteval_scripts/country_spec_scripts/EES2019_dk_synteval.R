# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Title: Script for Evaluating Synthetic Variables Estimation (EES 2019 Voter Study, Danish Sample) 
# Author: W.Haeussling
...
csdf_lst <- list('std'  = EES2019_dk,
                 'cdbk' = EES2019_cdbk_dk,
                 'SDM'  = EES2019_dk_stack)
...
# No models show inflated SE on any predictors.
