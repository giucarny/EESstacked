...
This repository contains the code for building the stacked data matrix (SDM) of the 2019 European 
Election Studies ([EES](http://europeanelectionstudies.net/)) voter study. The creation of this SDM is 
part of the research activities of the [ProConEU](https://www.mzes.uni-mannheim.de/proconeu/) project, 
an academic research effort^[
Funded by the German Federal Ministry of Education and Research 
([BMBF]((https://www.bmbf.de/bmbf/en/home/home_node.html)))
] analysing the enlarging gaps between 
...
An SDM consists of a long format data matrix in which each row represents the (dyadic) relationship 
...
and the related [codebook](https://access.gesis.org/dbk/67448) in the `~/EESstacked/Data/EES2019/` directory;
3. Run the [`EES2019_stack`](https://github.com/giucarny/EESstacked/blob/NewREADME/Scripts/EES2019_stack.R) script.
